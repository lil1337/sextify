...
export const LicenseIdentification = $root.LicenseIdentification = (() => {
    ...
    LicenseIdentification.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LicenseIdentification();
...
export const License = $root.License = (() => {
    ...
    License.encode = function encode(message, writer) {
        ...
        if (message.id != null && Object.hasOwnProperty.call(message, "id"))
            $root.LicenseIdentification.encode(message.id, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        if (message.policy != null && Object.hasOwnProperty.call(message, "policy"))
            $root.License.Policy.encode(message.policy, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        if (message.key != null && message.key.length)
            for (let i = 0; i < message.key.length; ++i)
                $root.License.KeyContainer.encode(message.key[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
    ...
    License.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.License();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
                    message.id = $root.LicenseIdentification.decode(reader, reader.uint32());
                    break;
                }
            case 2: {
                    message.policy = $root.License.Policy.decode(reader, reader.uint32());
                    break;
                }
            case 3: {
                    if (!(message.key && message.key.length))
                        message.key = [];
                    message.key.push($root.License.KeyContainer.decode(reader, reader.uint32()));
                    break;
                }
            case 4: {
    ...
    License.verify = function verify(message) {
        ...
        if (message.id != null && message.hasOwnProperty("id")) {
            let error = $root.LicenseIdentification.verify(message.id);
            if (error)
                return "id." + error;
        }
        if (message.policy != null && message.hasOwnProperty("policy")) {
            let error = $root.License.Policy.verify(message.policy);
            if (error)
                return "policy." + error;
        }
        if (message.key != null && message.hasOwnProperty("key")) {
            ...
            for (let i = 0; i < message.key.length; ++i) {
                let error = $root.License.KeyContainer.verify(message.key[i]);
                if (error)
                    return "key." + error;
            }
        }
    ...
    License.fromObject = function fromObject(object) {
        ...
        if (object.id != null) {
            ...
            message.id = $root.LicenseIdentification.fromObject(object.id);
        }
        if (object.policy != null) {
            if (typeof object.policy !== "object")
                throw TypeError(".License.policy: object expected");
            message.policy = $root.License.Policy.fromObject(object.policy);
        }
        if (object.key) {
            ...
            for (let i = 0; i < object.key.length; ++i) {
                ...
                message.key[i] = $root.License.KeyContainer.fromObject(object.key[i]);
            }
        }
    ...
    License.toObject = function toObject(message, options) {
        ...
        if (message.id != null && message.hasOwnProperty("id"))
            object.id = $root.LicenseIdentification.toObject(message.id, options);
        if (message.policy != null && message.hasOwnProperty("policy"))
            object.policy = $root.License.Policy.toObject(message.policy, options);
        if (message.key && message.key.length) {
            object.key = [];
            for (let j = 0; j < message.key.length; ++j)
                object.key[j] = $root.License.KeyContainer.toObject(message.key[j], options);
        }
        if (message.licenseStartTime != null && message.hasOwnProperty("licenseStartTime"))
    ...
    License.Policy = (function() {
        ...
        Policy.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.License.Policy();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    License.KeyContainer = (function() {
        ...
        KeyContainer.encode = function encode(message, writer) {
            ...
            if (message.requiredProtection != null && Object.hasOwnProperty.call(message, "requiredProtection"))
                $root.License.KeyContainer.OutputProtection.encode(message.requiredProtection, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            if (message.requestedProtection != null && Object.hasOwnProperty.call(message, "requestedProtection"))
                $root.License.KeyContainer.OutputProtection.encode(message.requestedProtection, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
            if (message.keyControl != null && Object.hasOwnProperty.call(message, "keyControl"))
                $root.License.KeyContainer.KeyControl.encode(message.keyControl, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            if (message.operatorSessionKeyPermissions != null && Object.hasOwnProperty.call(message, "operatorSessionKeyPermissions"))
                $root.License.KeyContainer.OperatorSessionKeyPermissions.encode(message.operatorSessionKeyPermissions, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
            if (message.videoResolutionConstraints != null && message.videoResolutionConstraints.length)
                for (let i = 0; i < message.videoResolutionConstraints.length; ++i)
                    $root.License.KeyContainer.VideoResolutionConstraint.encode(message.videoResolutionConstraints[i], writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
        ...
        KeyContainer.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.License.KeyContainer();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                ...
                case 6: {
                        message.requiredProtection = $root.License.KeyContainer.OutputProtection.decode(reader, reader.uint32());
                        break;
                    }
                case 7: {
                        message.requestedProtection = $root.License.KeyContainer.OutputProtection.decode(reader, reader.uint32());
                        break;
                    }
                case 8: {
                        message.keyControl = $root.License.KeyContainer.KeyControl.decode(reader, reader.uint32());
                        break;
                    }
                case 9: {
                        message.operatorSessionKeyPermissions = $root.License.KeyContainer.OperatorSessionKeyPermissions.decode(reader, reader.uint32());
                        break;
                    }
                case 10: {
                        if (!(message.videoResolutionConstraints && message.videoResolutionConstraints.length))
                            message.videoResolutionConstraints = [];
                        message.videoResolutionConstraints.push($root.License.KeyContainer.VideoResolutionConstraint.decode(reader, reader.uint32()));
                        break;
                    }
                case 11: {
        ...
        KeyContainer.verify = function verify(message) {
            ...
            if (message.requiredProtection != null && message.hasOwnProperty("requiredProtection")) {
                let error = $root.License.KeyContainer.OutputProtection.verify(message.requiredProtection);
                if (error)
                    return "requiredProtection." + error;
            }
            if (message.requestedProtection != null && message.hasOwnProperty("requestedProtection")) {
                let error = $root.License.KeyContainer.OutputProtection.verify(message.requestedProtection);
                if (error)
                    return "requestedProtection." + error;
            }
            if (message.keyControl != null && message.hasOwnProperty("keyControl")) {
                let error = $root.License.KeyContainer.KeyControl.verify(message.keyControl);
                if (error)
            ...
            if (message.operatorSessionKeyPermissions != null && message.hasOwnProperty("operatorSessionKeyPermissions")) {
                let error = $root.License.KeyContainer.OperatorSessionKeyPermissions.verify(message.operatorSessionKeyPermissions);
                if (error)
            ...
            if (message.videoResolutionConstraints != null && message.hasOwnProperty("videoResolutionConstraints")) {
                ...
                for (let i = 0; i < message.videoResolutionConstraints.length; ++i) {
                    let error = $root.License.KeyContainer.VideoResolutionConstraint.verify(message.videoResolutionConstraints[i]);
                    if (error)
        ...
        KeyContainer.fromObject = function fromObject(object) {
            ...
            if (object.requiredProtection != null) {
                ...
                message.requiredProtection = $root.License.KeyContainer.OutputProtection.fromObject(object.requiredProtection);
            }
            if (object.requestedProtection != null) {
                ...
                message.requestedProtection = $root.License.KeyContainer.OutputProtection.fromObject(object.requestedProtection);
            }
            if (object.keyControl != null) {
                ...
                message.keyControl = $root.License.KeyContainer.KeyControl.fromObject(object.keyControl);
            }
            if (object.operatorSessionKeyPermissions != null) {
                ...
                message.operatorSessionKeyPermissions = $root.License.KeyContainer.OperatorSessionKeyPermissions.fromObject(object.operatorSessionKeyPermissions);
            }
            if (object.videoResolutionConstraints) {
                ...
                for (let i = 0; i < object.videoResolutionConstraints.length; ++i) {
                    ...
                    message.videoResolutionConstraints[i] = $root.License.KeyContainer.VideoResolutionConstraint.fromObject(object.videoResolutionConstraints[i]);
                }
            }
        ...
        KeyContainer.toObject = function toObject(message, options) {
            ...
            if (message.requiredProtection != null && message.hasOwnProperty("requiredProtection"))
                object.requiredProtection = $root.License.KeyContainer.OutputProtection.toObject(message.requiredProtection, options);
            if (message.requestedProtection != null && message.hasOwnProperty("requestedProtection"))
                object.requestedProtection = $root.License.KeyContainer.OutputProtection.toObject(message.requestedProtection, options);
            if (message.keyControl != null && message.hasOwnProperty("keyControl"))
                object.keyControl = $root.License.KeyContainer.KeyControl.toObject(message.keyControl, options);
            if (message.operatorSessionKeyPermissions != null && message.hasOwnProperty("operatorSessionKeyPermissions"))
                object.operatorSessionKeyPermissions = $root.License.KeyContainer.OperatorSessionKeyPermissions.toObject(message.operatorSessionKeyPermissions, options);
            if (message.videoResolutionConstraints && message.videoResolutionConstraints.length) {
                object.videoResolutionConstraints = [];
                for (let j = 0; j < message.videoResolutionConstraints.length; ++j)
                    object.videoResolutionConstraints[j] = $root.License.KeyContainer.VideoResolutionConstraint.toObject(message.videoResolutionConstraints[j], options);
            }
            if (message.antiRollbackUsageTable != null && message.hasOwnProperty("antiRollbackUsageTable"))
        ...
        KeyContainer.KeyControl = (function() {
            ...
            KeyControl.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.License.KeyContainer.KeyControl();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        KeyContainer.OutputProtection = (function() {
            ...
            OutputProtection.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.License.KeyContainer.OutputProtection();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        KeyContainer.VideoResolutionConstraint = (function() {
            ...
            VideoResolutionConstraint.encode = function encode(message, writer) {
                ...
                if (message.requiredProtection != null && Object.hasOwnProperty.call(message, "requiredProtection"))
                    $root.License.KeyContainer.OutputProtection.encode(message.requiredProtection, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                return writer;
            };
            ...
            VideoResolutionConstraint.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.License.KeyContainer.VideoResolutionConstraint();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        KeyContainer.OperatorSessionKeyPermissions = (function() {
            ...
            OperatorSessionKeyPermissions.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.License.KeyContainer.OperatorSessionKeyPermissions();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
...
export const LicenseRequest = $root.LicenseRequest = (() => {
    ...
    LicenseRequest.encode = function encode(message, writer) {
        ...
        if (message.clientId != null && Object.hasOwnProperty.call(message, "clientId"))
            $root.ClientIdentification.encode(message.clientId, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        if (message.contentId != null && Object.hasOwnProperty.call(message, "contentId"))
            $root.LicenseRequest.ContentIdentification.encode(message.contentId, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        if (message.type != null && Object.hasOwnProperty.call(message, "type"))
        ...
        if (message.encryptedClientId != null && Object.hasOwnProperty.call(message, "encryptedClientId"))
            $root.EncryptedClientIdentification.encode(message.encryptedClientId, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
        return writer;
    };
    ...
    LicenseRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LicenseRequest();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
                    message.clientId = $root.ClientIdentification.decode(reader, reader.uint32());
                    break;
                }
            case 2: {
                    message.contentId = $root.LicenseRequest.ContentIdentification.decode(reader, reader.uint32());
                    break;
                }
            case 3: {
                    message.type = reader.int32();
            ...
            case 8: {
                    message.encryptedClientId = $root.EncryptedClientIdentification.decode(reader, reader.uint32());
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    LicenseRequest.verify = function verify(message) {
        ...
        if (message.clientId != null && message.hasOwnProperty("clientId")) {
            let error = $root.ClientIdentification.verify(message.clientId);
            if (error)
                return "clientId." + error;
        }
        if (message.contentId != null && message.hasOwnProperty("contentId")) {
            let error = $root.LicenseRequest.ContentIdentification.verify(message.contentId);
            if (error)
        ...
        if (message.encryptedClientId != null && message.hasOwnProperty("encryptedClientId")) {
            let error = $root.EncryptedClientIdentification.verify(message.encryptedClientId);
            if (error)
    ...
    LicenseRequest.fromObject = function fromObject(object) {
        ...
        if (object.clientId != null) {
            ...
            message.clientId = $root.ClientIdentification.fromObject(object.clientId);
        }
        if (object.contentId != null) {
            if (typeof object.contentId !== "object")
                throw TypeError(".LicenseRequest.contentId: object expected");
            message.contentId = $root.LicenseRequest.ContentIdentification.fromObject(object.contentId);
        }
        switch (object.type) {
        default:
            if (typeof object.type === "number") {
        ...
        if (object.encryptedClientId != null) {
            ...
            message.encryptedClientId = $root.EncryptedClientIdentification.fromObject(object.encryptedClientId);
        }
        return message;
    };
    ...
    LicenseRequest.toObject = function toObject(message, options) {
        ...
        if (message.clientId != null && message.hasOwnProperty("clientId"))
            object.clientId = $root.ClientIdentification.toObject(message.clientId, options);
        if (message.contentId != null && message.hasOwnProperty("contentId"))
            object.contentId = $root.LicenseRequest.ContentIdentification.toObject(message.contentId, options);
        if (message.type != null && message.hasOwnProperty("type"))
        ...
        if (message.encryptedClientId != null && message.hasOwnProperty("encryptedClientId"))
            object.encryptedClientId = $root.EncryptedClientIdentification.toObject(message.encryptedClientId, options);
        return object;
    };
    ...
    LicenseRequest.ContentIdentification = (function() {
        ...
        ContentIdentification.encode = function encode(message, writer) {
            ...
            if (message.widevinePsshData != null && Object.hasOwnProperty.call(message, "widevinePsshData"))
                $root.LicenseRequest.ContentIdentification.WidevinePsshData.encode(message.widevinePsshData, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.webmKeyId != null && Object.hasOwnProperty.call(message, "webmKeyId"))
                $root.LicenseRequest.ContentIdentification.WebmKeyId.encode(message.webmKeyId, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.existingLicense != null && Object.hasOwnProperty.call(message, "existingLicense"))
                $root.LicenseRequest.ContentIdentification.ExistingLicense.encode(message.existingLicense, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.initData != null && Object.hasOwnProperty.call(message, "initData"))
                $root.LicenseRequest.ContentIdentification.InitData.encode(message.initData, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
        ...
        ContentIdentification.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LicenseRequest.ContentIdentification();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                        message.widevinePsshData = $root.LicenseRequest.ContentIdentification.WidevinePsshData.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.webmKeyId = $root.LicenseRequest.ContentIdentification.WebmKeyId.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.existingLicense = $root.LicenseRequest.ContentIdentification.ExistingLicense.decode(reader, reader.uint32());
                        break;
                    }
                case 4: {
                        message.initData = $root.LicenseRequest.ContentIdentification.InitData.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        ContentIdentification.verify = function verify(message) {
            ...
            if (message.widevinePsshData != null && message.hasOwnProperty("widevinePsshData")) {
                ...
                {
                    let error = $root.LicenseRequest.ContentIdentification.WidevinePsshData.verify(message.widevinePsshData);
                    if (error)
            ...
            if (message.webmKeyId != null && message.hasOwnProperty("webmKeyId")) {
                ...
                properties.contentIdVariant = 1;
                {
                    let error = $root.LicenseRequest.ContentIdentification.WebmKeyId.verify(message.webmKeyId);
                    if (error)
            ...
            if (message.existingLicense != null && message.hasOwnProperty("existingLicense")) {
                ...
                properties.contentIdVariant = 1;
                {
                    let error = $root.LicenseRequest.ContentIdentification.ExistingLicense.verify(message.existingLicense);
                    if (error)
            ...
            if (message.initData != null && message.hasOwnProperty("initData")) {
                ...
                properties.contentIdVariant = 1;
                {
                    let error = $root.LicenseRequest.ContentIdentification.InitData.verify(message.initData);
                    if (error)
        ...
        ContentIdentification.fromObject = function fromObject(object) {
            ...
            if (object.widevinePsshData != null) {
                ...
                message.widevinePsshData = $root.LicenseRequest.ContentIdentification.WidevinePsshData.fromObject(object.widevinePsshData);
            }
            if (object.webmKeyId != null) {
                ...
                message.webmKeyId = $root.LicenseRequest.ContentIdentification.WebmKeyId.fromObject(object.webmKeyId);
            }
            if (object.existingLicense != null) {
                ...
                message.existingLicense = $root.LicenseRequest.ContentIdentification.ExistingLicense.fromObject(object.existingLicense);
            }
            if (object.initData != null) {
                ...
                message.initData = $root.LicenseRequest.ContentIdentification.InitData.fromObject(object.initData);
            }
            return message;
        };
        ...
        ContentIdentification.toObject = function toObject(message, options) {
            ...
            let object = {};
            if (message.widevinePsshData != null && message.hasOwnProperty("widevinePsshData")) {
                object.widevinePsshData = $root.LicenseRequest.ContentIdentification.WidevinePsshData.toObject(message.widevinePsshData, options);
                if (options.oneofs)
                    object.contentIdVariant = "widevinePsshData";
            }
            if (message.webmKeyId != null && message.hasOwnProperty("webmKeyId")) {
                object.webmKeyId = $root.LicenseRequest.ContentIdentification.WebmKeyId.toObject(message.webmKeyId, options);
                if (options.oneofs)
                    object.contentIdVariant = "webmKeyId";
            }
            if (message.existingLicense != null && message.hasOwnProperty("existingLicense")) {
                object.existingLicense = $root.LicenseRequest.ContentIdentification.ExistingLicense.toObject(message.existingLicense, options);
                if (options.oneofs)
                    object.contentIdVariant = "existingLicense";
            }
            if (message.initData != null && message.hasOwnProperty("initData")) {
                object.initData = $root.LicenseRequest.ContentIdentification.InitData.toObject(message.initData, options);
                if (options.oneofs)
        ...
        ContentIdentification.WidevinePsshData = (function() {
            ...
            WidevinePsshData.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LicenseRequest.ContentIdentification.WidevinePsshData();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        ContentIdentification.WebmKeyId = (function() {
            ...
            WebmKeyId.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LicenseRequest.ContentIdentification.WebmKeyId();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        ContentIdentification.ExistingLicense = (function() {
            ...
            ExistingLicense.encode = function encode(message, writer) {
                ...
                if (message.licenseId != null && Object.hasOwnProperty.call(message, "licenseId"))
                    $root.LicenseIdentification.encode(message.licenseId, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            ...
            ExistingLicense.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LicenseRequest.ContentIdentification.ExistingLicense();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                            message.licenseId = $root.LicenseIdentification.decode(reader, reader.uint32());
                            break;
                        }
                    case 2: {
            ...
            ExistingLicense.verify = function verify(message) {
                ...
                if (message.licenseId != null && message.hasOwnProperty("licenseId")) {
                    let error = $root.LicenseIdentification.verify(message.licenseId);
                    if (error)
            ...
            ExistingLicense.fromObject = function fromObject(object) {
                ...
                if (object.licenseId != null) {
                    ...
                    message.licenseId = $root.LicenseIdentification.fromObject(object.licenseId);
                }
            ...
            ExistingLicense.toObject = function toObject(message, options) {
                ...
                if (message.licenseId != null && message.hasOwnProperty("licenseId"))
                    object.licenseId = $root.LicenseIdentification.toObject(message.licenseId, options);
                if (message.secondsSinceStarted != null && message.hasOwnProperty("secondsSinceStarted"))
        ...
        ContentIdentification.InitData = (function() {
            ...
            InitData.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LicenseRequest.ContentIdentification.InitData();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
...
export const MetricData = $root.MetricData = (() => {
    ...
    MetricData.encode = function encode(message, writer) {
        ...
        if (message.metricData != null && message.metricData.length)
            for (let i = 0; i < message.metricData.length; ++i)
                $root.MetricData.TypeValue.encode(message.metricData[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        return writer;
    };
    ...
    MetricData.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MetricData();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 2: {
                    if (!(message.metricData && message.metricData.length))
                        message.metricData = [];
                    message.metricData.push($root.MetricData.TypeValue.decode(reader, reader.uint32()));
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    MetricData.verify = function verify(message) {
        ...
        if (message.metricData != null && message.hasOwnProperty("metricData")) {
            ...
            for (let i = 0; i < message.metricData.length; ++i) {
                let error = $root.MetricData.TypeValue.verify(message.metricData[i]);
                if (error)
    ...
    MetricData.fromObject = function fromObject(object) {
        ...
        if (object.metricData) {
            ...
            for (let i = 0; i < object.metricData.length; ++i) {
                ...
                message.metricData[i] = $root.MetricData.TypeValue.fromObject(object.metricData[i]);
            }
        }
        return message;
    };
    ...
    MetricData.toObject = function toObject(message, options) {
        ...
        if (message.metricData && message.metricData.length) {
            ...
            for (let j = 0; j < message.metricData.length; ++j)
                object.metricData[j] = $root.MetricData.TypeValue.toObject(message.metricData[j], options);
        }
        return object;
    };
    ...
    MetricData.TypeValue = (function() {
        ...
        TypeValue.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MetricData.TypeValue();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
...
export const VersionInfo = $root.VersionInfo = (() => {
    ...
    VersionInfo.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VersionInfo();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const SignedMessage = $root.SignedMessage = (() => {
    ...
    SignedMessage.encode = function encode(message, writer) {
        ...
        if (message.metricData != null && message.metricData.length)
            for (let i = 0; i < message.metricData.length; ++i)
                $root.MetricData.encode(message.metricData[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
        if (message.serviceVersionInfo != null && Object.hasOwnProperty.call(message, "serviceVersionInfo"))
            $root.VersionInfo.encode(message.serviceVersionInfo, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
    ...
    SignedMessage.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.SignedMessage();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 6: {
                    if (!(message.metricData && message.metricData.length))
                        message.metricData = [];
                    message.metricData.push($root.MetricData.decode(reader, reader.uint32()));
                    break;
                }
            case 7: {
                    message.serviceVersionInfo = $root.VersionInfo.decode(reader, reader.uint32());
                    break;
                }
            case 8: {
    ...
    SignedMessage.verify = function verify(message) {
        ...
        if (message.metricData != null && message.hasOwnProperty("metricData")) {
            if (!Array.isArray(message.metricData))
                return "metricData: array expected";
            for (let i = 0; i < message.metricData.length; ++i) {
                let error = $root.MetricData.verify(message.metricData[i]);
                if (error)
                    return "metricData." + error;
            }
        }
        if (message.serviceVersionInfo != null && message.hasOwnProperty("serviceVersionInfo")) {
            let error = $root.VersionInfo.verify(message.serviceVersionInfo);
            if (error)
    ...
    SignedMessage.fromObject = function fromObject(object) {
        ...
        if (object.metricData) {
            ...
            for (let i = 0; i < object.metricData.length; ++i) {
                ...
                message.metricData[i] = $root.MetricData.fromObject(object.metricData[i]);
            }
        }
        if (object.serviceVersionInfo != null) {
            ...
            message.serviceVersionInfo = $root.VersionInfo.fromObject(object.serviceVersionInfo);
        }
    ...
    SignedMessage.toObject = function toObject(message, options) {
        ...
        if (message.metricData && message.metricData.length) {
            object.metricData = [];
            for (let j = 0; j < message.metricData.length; ++j)
                object.metricData[j] = $root.MetricData.toObject(message.metricData[j], options);
        }
        if (message.serviceVersionInfo != null && message.hasOwnProperty("serviceVersionInfo"))
            object.serviceVersionInfo = $root.VersionInfo.toObject(message.serviceVersionInfo, options);
        if (message.sessionKeyType != null && message.hasOwnProperty("sessionKeyType"))
...
export const ClientIdentification = $root.ClientIdentification = (() => {
    ...
    ClientIdentification.encode = function encode(message, writer) {
        ...
        if (message.clientCapabilities != null && Object.hasOwnProperty.call(message, "clientCapabilities"))
            $root.ClientIdentification.ClientCapabilities.encode(message.clientCapabilities, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
        ...
        if (message.deviceCredentials != null && message.deviceCredentials.length)
            for (let i = 0; i < message.deviceCredentials.length; ++i)
                $root.ClientIdentification.ClientCredentials.encode(message.deviceCredentials[i], writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
        return writer;
    };
    ...
    ClientIdentification.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientIdentification();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 3: {
                    if (!(message.clientInfo && message.clientInfo.length))
                        message.clientInfo = [];
                    message.clientInfo.push($root.ClientIdentification.NameValue.decode(reader, reader.uint32()));
                    break;
                }
            case 4: {
                    message.providerClientToken = reader.bytes();
            ...
            case 6: {
                    message.clientCapabilities = $root.ClientIdentification.ClientCapabilities.decode(reader, reader.uint32());
                    break;
                }
            case 7: {
            ...
            case 8: {
                    ...
                    message.deviceCredentials.push($root.ClientIdentification.ClientCredentials.decode(reader, reader.uint32()));
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    ClientIdentification.verify = function verify(message) {
        ...
        if (message.clientInfo != null && message.hasOwnProperty("clientInfo")) {
            ...
            for (let i = 0; i < message.clientInfo.length; ++i) {
                let error = $root.ClientIdentification.NameValue.verify(message.clientInfo[i]);
                if (error)
        ...
        if (message.clientCapabilities != null && message.hasOwnProperty("clientCapabilities")) {
            let error = $root.ClientIdentification.ClientCapabilities.verify(message.clientCapabilities);
            if (error)
        ...
        if (message.deviceCredentials != null && message.hasOwnProperty("deviceCredentials")) {
            ...
            for (let i = 0; i < message.deviceCredentials.length; ++i) {
                let error = $root.ClientIdentification.ClientCredentials.verify(message.deviceCredentials[i]);
                if (error)
    ...
    ClientIdentification.fromObject = function fromObject(object) {
        ...
        if (object.clientCapabilities != null) {
            ...
            message.clientCapabilities = $root.ClientIdentification.ClientCapabilities.fromObject(object.clientCapabilities);
        }
        ...
        if (object.deviceCredentials) {
            ...
            for (let i = 0; i < object.deviceCredentials.length; ++i) {
                ...
                message.deviceCredentials[i] = $root.ClientIdentification.ClientCredentials.fromObject(object.deviceCredentials[i]);
            }
        }
        return message;
    };
    ...
    ClientIdentification.toObject = function toObject(message, options) {
        ...
        if (message.clientCapabilities != null && message.hasOwnProperty("clientCapabilities"))
            object.clientCapabilities = $root.ClientIdentification.ClientCapabilities.toObject(message.clientCapabilities, options);
        if (message.vmpData != null && message.hasOwnProperty("vmpData"))
        ...
        if (message.deviceCredentials && message.deviceCredentials.length) {
            ...
            for (let j = 0; j < message.deviceCredentials.length; ++j)
                object.deviceCredentials[j] = $root.ClientIdentification.ClientCredentials.toObject(message.deviceCredentials[j], options);
        }
        return object;
    };
    ...
    ClientIdentification.NameValue = (function() {
        ...
        NameValue.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientIdentification.NameValue();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    ClientIdentification.ClientCapabilities = (function() {
        ...
        ClientCapabilities.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientIdentification.ClientCapabilities();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    ClientIdentification.ClientCredentials = (function() {
        ...
        ClientCredentials.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientIdentification.ClientCredentials();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
...
export const EncryptedClientIdentification = $root.EncryptedClientIdentification = (() => {
    ...
    EncryptedClientIdentification.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.EncryptedClientIdentification();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const DrmCertificate = $root.DrmCertificate = (() => {
    ...
    DrmCertificate.encode = function encode(message, writer) {
        ...
        if (message.encryptionKey != null && Object.hasOwnProperty.call(message, "encryptionKey"))
            $root.DrmCertificate.EncryptionKey.encode(message.encryptionKey, writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
    ...
    DrmCertificate.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.DrmCertificate();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 11: {
                    message.encryptionKey = $root.DrmCertificate.EncryptionKey.decode(reader, reader.uint32());
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    DrmCertificate.verify = function verify(message) {
        ...
        if (message.encryptionKey != null && message.hasOwnProperty("encryptionKey")) {
            let error = $root.DrmCertificate.EncryptionKey.verify(message.encryptionKey);
            if (error)
    ...
    DrmCertificate.fromObject = function fromObject(object) {
        ...
        if (object.encryptionKey != null) {
            ...
            message.encryptionKey = $root.DrmCertificate.EncryptionKey.fromObject(object.encryptionKey);
        }
        return message;
    };
    ...
    DrmCertificate.toObject = function toObject(message, options) {
        ...
        if (message.encryptionKey != null && message.hasOwnProperty("encryptionKey"))
            object.encryptionKey = $root.DrmCertificate.EncryptionKey.toObject(message.encryptionKey, options);
        if (message.expirationTimeSeconds != null && message.hasOwnProperty("expirationTimeSeconds"))
    ...
    DrmCertificate.EncryptionKey = (function() {
        ...
        EncryptionKey.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.DrmCertificate.EncryptionKey();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
...
export const SignedDrmCertificate = $root.SignedDrmCertificate = (() => {
    ...
    SignedDrmCertificate.encode = function encode(message, writer) {
        ...
        if (message.signer != null && Object.hasOwnProperty.call(message, "signer"))
            $root.SignedDrmCertificate.encode(message.signer, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
    ...
    SignedDrmCertificate.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.SignedDrmCertificate();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 3: {
                    message.signer = $root.SignedDrmCertificate.decode(reader, reader.uint32());
                    break;
                }
            case 4: {
    ...
    SignedDrmCertificate.verify = function verify(message) {
        ...
        if (message.signer != null && message.hasOwnProperty("signer")) {
            let error = $root.SignedDrmCertificate.verify(message.signer);
            if (error)
                return "signer." + error;
        }
    ...
    SignedDrmCertificate.fromObject = function fromObject(object) {
        ...
        if (object.signer != null) {
            ...
            message.signer = $root.SignedDrmCertificate.fromObject(object.signer);
        }
    ...
    SignedDrmCertificate.toObject = function toObject(message, options) {
        ...
        if (message.signature != null && message.hasOwnProperty("signature"))
            object.signature = options.bytes === String ? $util.base64.encode(message.signature, 0, message.signature.length) : options.bytes === Array ? Array.prototype.slice.call(message.signature) : message.signature;
        if (message.signer != null && message.hasOwnProperty("signer"))
            object.signer = $root.SignedDrmCertificate.toObject(message.signer, options);
        if (message.hashAlgorithm != null && message.hasOwnProperty("hashAlgorithm"))
...
export const WidevinePsshData = $root.WidevinePsshData = (() => {
    ...
    WidevinePsshData.encode = function encode(message, writer) {
        ...
        if (message.entitledKeys != null && message.entitledKeys.length)
            for (let i = 0; i < message.entitledKeys.length; ++i)
                $root.WidevinePsshData.EntitledKey.encode(message.entitledKeys[i], writer.uint32(/* id 14, wireType 2 =*/114).fork()).ldelim();
    ...
    WidevinePsshData.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.WidevinePsshData();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 2: {
            ...
            case 14: {
                    ...
                    message.entitledKeys.push($root.WidevinePsshData.EntitledKey.decode(reader, reader.uint32()));
                    break;
                }
            case 15: {
    ...
    WidevinePsshData.verify = function verify(message) {
        ...
        if (message.entitledKeys != null && message.hasOwnProperty("entitledKeys")) {
            ...
            for (let i = 0; i < message.entitledKeys.length; ++i) {
                let error = $root.WidevinePsshData.EntitledKey.verify(message.entitledKeys[i]);
                if (error)
    ...
    WidevinePsshData.fromObject = function fromObject(object) {
        ...
        if (object.entitledKeys) {
            ...
            for (let i = 0; i < object.entitledKeys.length; ++i) {
                ...
                message.entitledKeys[i] = $root.WidevinePsshData.EntitledKey.fromObject(object.entitledKeys[i]);
            }
        }
    ...
    WidevinePsshData.toObject = function toObject(message, options) {
        ...
        if (message.entitledKeys && message.entitledKeys.length) {
            ...
            for (let j = 0; j < message.entitledKeys.length; ++j)
                object.entitledKeys[j] = $root.WidevinePsshData.EntitledKey.toObject(message.entitledKeys[j], options);
        }
        if (message.videoFeature != null && message.hasOwnProperty("videoFeature"))
    ...
    WidevinePsshData.EntitledKey = (function() {
        ...
        EntitledKey.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.WidevinePsshData.EntitledKey();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
...
export const FileHashes = $root.FileHashes = (() => {
    ...
    FileHashes.encode = function encode(message, writer) {
        ...
        if (message.signatures != null && message.signatures.length)
            for (let i = 0; i < message.signatures.length; ++i)
                $root.FileHashes.Signature.encode(message.signatures[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        return writer;
    };
    ...
    FileHashes.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.FileHashes();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 2: {
                    if (!(message.signatures && message.signatures.length))
                        message.signatures = [];
                    message.signatures.push($root.FileHashes.Signature.decode(reader, reader.uint32()));
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    FileHashes.verify = function verify(message) {
        ...
        if (message.signatures != null && message.hasOwnProperty("signatures")) {
            ...
            for (let i = 0; i < message.signatures.length; ++i) {
                let error = $root.FileHashes.Signature.verify(message.signatures[i]);
                if (error)
    ...
    FileHashes.fromObject = function fromObject(object) {
        ...
        if (object.signatures) {
            ...
            for (let i = 0; i < object.signatures.length; ++i) {
                ...
                message.signatures[i] = $root.FileHashes.Signature.fromObject(object.signatures[i]);
            }
        }
        return message;
    };
    ...
    FileHashes.toObject = function toObject(message, options) {
        ...
        if (message.signatures && message.signatures.length) {
            ...
            for (let j = 0; j < message.signatures.length; ++j)
                object.signatures[j] = $root.FileHashes.Signature.toObject(message.signatures[j], options);
        }
        return object;
    };
    ...
    FileHashes.Signature = (function() {
        ...
        Signature.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.FileHashes.Signature();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {

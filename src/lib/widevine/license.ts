...
import { LicenseRequest_RequestType } from "./enums/LicenseRequest_RequestType.js";
import { SignedMessage_MessageType } from "./enums/SignedMessage_MessageType.js";
...
export class Session {
  ...
  async setServiceCertificateFromMessage(rawSignedMessage: Buffer) {
    const signedMessage = SignedMessage.decode(rawSignedMessage);
  ...
  private _encryptClientIdentification(
    ...
    const encryptedClientIdentification: any = {
